#!/bin/bash
#Generated on 2021-11-04 18:59:40 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=2cd33c3d-825f-4216-9ef4-2e2cef0bc077&pack=en-us&edition=professional&aria2=2"
if [ $? != 0 ]; then
